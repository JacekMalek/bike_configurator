...
public class BikeDto {
    ...
    public BikeDto(@NotNull String bikeName, @NotNull String frame, @NotNull String fork, @NotNull String wheels,
                   ...
                   @NotNull String shifters, @NotNull String pedals, Double weight, BigDecimal price) {
