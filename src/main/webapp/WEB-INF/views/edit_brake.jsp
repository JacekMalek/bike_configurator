...
<body>
<h3>Edycja hamulców:</h3>

<c:url var="edit_url" value="/brake/edit"/>
<form:form method="post" modelAttribute="brakeDto" action="${edit_url}">
    ...
    <p>
        Typ: <form:select path="type" items="${type}" /><br>
