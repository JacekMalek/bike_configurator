...
<table class="table table-hover table-bordered" >
    ...
    <c:forEach items="${parts}" var="part">
        <tr>
            ...
            <td><a href="/admin/books/book/${part.id}"><input type="button" value="Pokaż" class="btn btn-primary" /></a></td>
            <td><a href="/admin/books/edit/${part.id}"><input type="button" value="Edytuj" class="btn btn-secondary"/></a>
                <button type="button" class="btn btn-danger"><a href="/admin/books/delete/${part.id}"><i class="fa fa-trash-o fa-lg"></i> Usuń </a></button></td>
        </tr>
    </c:forEach>
    </tbody>
</table>
